...
В этом задании вы реализуете функцию count, которая принимает целое число и возвращает количество цифр в factorial(n).

Например, count(5) = 3, потому что 5! = 120, а 120 состоит из 3 цифр.

Больше примеров в тестовых случаях.

Перебор невозможен. Небольшое исследование будет очень кстати, так как это хорошо известная серия.
