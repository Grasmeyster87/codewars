...
All valid time signatures must have a bottom number that is a power of 2. If the given signature is invalid, return None in Python, null in Javascript and TypeScript, or -1 in C.
